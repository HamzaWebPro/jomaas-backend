const verificationTemplate = (verificationToken) => {
  return `<div style="background: linear-gradient(to bottom, #005B89, #61443E); display: flex; justify-content: center; align-items: center; height: 100vh; padding: 20px; box-sizing: border-box;">
  <div style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px; text-align: center; max-width: 400px; width: 100%; box-sizing: border-box;">
    <img src="YOUR_LOGO_LINK_HERE" alt="Logo" style="width: 100px; height: 50px; margin: 20px auto; display: block;">
